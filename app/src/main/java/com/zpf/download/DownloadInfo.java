...
import static com.zpf.download.Downloads.Impl.VISIBILITY_VISIBLE;
import static com.zpf.download.Downloads.Impl.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;
...
//    }
    ...
    public static DownloadInfo queryDownloadInfo(Context context, long downloadId) {
        return DownloadInfoManager.INSTANCE.query((int) downloadId);
    }
...
//    }
    ...
    public Uri getAllDownloadsUri() {
        ...
        return FileUriUtil.pathToUri(mContext, file);
