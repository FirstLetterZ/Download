...
import static com.zpf.download.Downloads.Impl.DESTINATION_EXTERNAL;
import static com.zpf.download.Downloads.Impl.DESTINATION_FILE_URI;
import static com.zpf.download.Downloads.Impl.FLAG_REQUIRES_CHARGING;
import static com.zpf.download.Downloads.Impl.FLAG_REQUIRES_DEVICE_IDLE;
...
//            getDownloadNotifier(context).update();
    ...
    public static boolean scheduleJob(Context context, DownloadInfo info) {
        ...
        Log.w("DOWNLOAD_TAG", "scheduleJob==>" + info.mId);
...
//        }
    ...
    private static String chooseFilename(String url, String hint, String contentDisposition,
        ...
        filename = IoUtils.buildValidFatFilename(filename);
