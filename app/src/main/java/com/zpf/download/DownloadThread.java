 ...
 */
public class DownloadThread extends Thread implements IShutdown {
...
//            mInfoDelta.writeToDatabaseOrThrow();
    ...
    private void parseOkHeaders(HttpURLConnection conn) throws StopRequestException {
        ...
        Log.i(TAG, "parseOkHeaders. TotalBytes = " + mInfoDelta.mTotalBytes + ",transferEncoding = " + transferEncoding);
